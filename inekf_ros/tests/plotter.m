...
%hold on;
plot3(filtered(:,2), filtered(:,3), filtered(:,4), 'linewidth', 2);hold on;
plot3(odo(:,2), odo(:,3), odo(:,4), 'linewidth', 2);
legend('Filtered position', 'GPS position', 'location', 'best')
%legend('Base\_link position', 'GPS\_link position', 'Filtered GPS position','Transformed base position',  'location', 'best')
